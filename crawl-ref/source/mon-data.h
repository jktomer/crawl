...

{
    ...
    13, 780,
    0, 14, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    10, MONS_RAT, MONS_CRYSTAL_ECHIDNA, MH_NONLIVING, WILL_INVULN,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 640,
...

{
    ...
    { {AT_STING, AF_POISON, 30}, {AT_CLAW, AF_PLAIN, 10},
      {AT_CLAW, AF_PLAIN, 10}, AT_NO_ATK },
    14, 990,
    15, 7, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    { {AT_DANCE, AF_CONFUSE, 19}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 280,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, {AT_HIT, AF_PLAIN, 16}, {AT_HIT, AF_PLAIN, 16},
       AT_NO_ATK },
    9, 585,
    10, 6, MST_HOWLER_MONKEY, true, S_SCREAM,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
...

{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    13, MONS_SPIDER, MONS_BROODMOTHER, MH_NATURAL, 60,
...

{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    13, MONS_SPIDER, MONS_CULICIVORA, MH_NATURAL, 20,
    { {AT_BITE, AF_VAMPIRIC, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 340,
    2, 11, MST_CULICIVORA, true, S_HISS,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_ARACHNID,
...

{
    ...
    { {AT_HIT, AF_BARBS, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 420,
    12, 5, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE,
...
{
    MONS_MINER_BEE, 'y', WHITE, "miner bee",
    M_NO_SKELETON | M_FLIES | M_BURROWS,
    MR_VUL_POISON,
    11, MONS_KILLER_BEE, MONS_MINER_BEE, MH_NATURAL, 40,
    { {AT_STING, AF_POISON, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 490,
    2, 18, MST_NO_SPELLS, true, S_BUZZ,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
    {TILEP_MONS_MINER_BEE}, TILE_CORPSE_MINER_BEE
},
...

{
    ...
    { {AT_HIT, AF_DRAIN_STAT, 28}, {AT_HIT, AF_DRAIN_STAT, 28},
      {AT_STING, AF_DRAIN_STAT, 20}, AT_NO_ATK },
    13, 715,
...

{
    ...
    9, 525,
    3, 10, MST_SUN_MOTH, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_INSECT_WINGED,
...

{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    12, MONS_MUMMY, MONS_PHARAOH_ANT, MH_UNDEAD, 60,
    { {AT_BITE, AF_DRAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 540,
    3, 12, MST_NO_SPELLS, true, S_MOAN,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_FEMALE,
    MR_NO_FLAGS,
    10, MONS_JOROGUMO, MONS_JOROGUMO, MH_NATURAL | MH_EVIL, 60,
    { {AT_HIT, AF_POISON_PARALYSE, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 800,
    3, 10, MST_JOROGUMO, true, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
...
// dangerous, but still come out at 200+ XP
{
    ...
    { {AT_HIT, AF_BLINK_WITH, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 285,
...

{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    10, MONS_WALKING_TOME, MONS_EARTHEN_TOME, MH_NONLIVING, WILL_INVULN,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    8, 12, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    10, 550,
    6, 12, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// those of the relevant base demonspawn type.
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 325,
    0, 0, MST_DEMONSPAWN_BLOOD_SAINT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 600,
    0, 2, MST_DEMONSPAWN_WARMONGER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 375,
    0, 0, MST_DEMONSPAWN_CORRUPTER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 375,
    0, 0, MST_DEMONSPAWN_BLACK_SUN, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC
        | MR_RES_PETRIFY,
    10, MONS_STATUE, MONS_OBSIDIAN_STATUE, MH_NONLIVING | MH_EVIL, WILL_INVULN,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
...
// "F"rogs.
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 390,
    0, 16, MST_PRINCE_RIBBIT, true, S_CROAK,
...
// Horrors
{
    ...
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_MALE,
    MR_RES_ELEC | MR_RES_POISON | MR_RES_COLD,
    13, MONS_THRASHING_HORROR, MONS_MLIOGLOTL, MH_NONLIVING, 120,
