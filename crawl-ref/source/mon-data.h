...

{
    ...
    { {AT_BITE, AF_SPIDER, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 1400,
...

{
    ...
    10, 720,
    12, 8, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_BITE, AF_DRAIN, 38}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 440,
    5, 12, MST_NO_SPELLS, false, S_MOAN,
    I_ANIMAL, HT_LAND, 14, DEFAULT_ENERGY,
...

{
    ...
    12, 900,
    3, 14, MST_JOROGUMO, true, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
