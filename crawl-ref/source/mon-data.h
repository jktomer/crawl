...

{
    ...
    MR_VUL_POISON,
    10, MONS_KILLER_BEE, MONS_MINER_BEE, MH_NATURAL, 40,
...

{
    ...
    9, 825,
    6, 10, MST_SUN_MOTH, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_INSECT_WINGED,
...

{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    10, MONS_MUMMY, MONS_PHARAOH_ANT, MH_UNDEAD, 60,
    { {AT_BITE, AF_DRAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 440,
    3, 12, MST_NO_SPELLS, false, S_MOAN,
    I_ANIMAL, HT_LAND, 14, DEFAULT_ENERGY,
