...
// These historically don't get kills after D:7ish.
  ...
  {  6, 12,  800, PEAK, MONS_ORC_WARRIOR },
  ...
  {  8, 14,  800, PEAK, MONS_TWO_HEADED_OGRE },
...
{ // Spider Nest
  ...
  {  1,  4,   700, FLAT, MONS_JUMPING_SPIDER },
  {  1,  4,   900, FALL, MONS_JUMPING_SPIDER },
  {  1,  4,   600, FLAT, MONS_TARANTELLA },
  {  1,  4,   500, FALL, MONS_TARANTELLA },
  {  1,  4,   600, FLAT, MONS_CULICIVORA },
  {  1,  4,   500, FALL, MONS_CULICIVORA },
  {  1,  4,   900, FLAT, MONS_DEMONIC_CRAWLER },
  {  1,  4,   300, FALL, MONS_DEMONIC_CRAWLER },
  // Harder enemies:
  {  1,  4,   600, FLAT, MONS_WOLF_SPIDER },
  {  1,  4,   800, RISE, MONS_WOLF_SPIDER },
  {  1,  4,   200, FLAT, MONS_TORPOR_SNAIL },
  {  1,  4,   200, RISE, MONS_TORPOR_SNAIL },
  {  1,  4,   400, FLAT, MONS_ENTROPY_WEAVER },
  {  1,  4,   300, RISE, MONS_ENTROPY_WEAVER },
  {  1,  4,   300, FLAT, MONS_MELIAI },
  {  1,  4,   200, RISE, MONS_MELIAI },
  {  1,  4,   400, FLAT, MONS_PHARAOH_ANT },
  {  1,  4,   400, RISE, MONS_PHARAOH_ANT },
  {  1,  4,   100, FLAT, MONS_MOTH_OF_WRATH },
  {  1,  4,   100, RISE, MONS_MOTH_OF_WRATH },
  {  1,  4,   300, FLAT, MONS_STEELBARB_WORM },
  {  1,  4,   300, RISE, MONS_STEELBARB_WORM },
  {  1,  4,   400, FLAT, MONS_MINER_BEE },
  {  1,  4,   200, RISE, MONS_MINER_BEE },
  {  1,  4,   100, FLAT, MONS_ORB_SPIDER },
  {  1,  4,   300, RISE, MONS_ORB_SPIDER },
  // Top-tier threats:
  {  1,  4,   50,  FLAT, MONS_GHOST_MOTH },
  {  1,  4,   150, RISE, MONS_GHOST_MOTH },
  {  1,  4,   50,  FLAT, MONS_EMPEROR_SCORPION },
  {  1,  4,   150, RISE, MONS_EMPEROR_SCORPION },
  {  1,  4,   50,  FLAT, MONS_BROODMOTHER },
  {  1,  4,   150, RISE, MONS_BROODMOTHER },
  {  1,  4,   25,  FLAT, MONS_JOROGUMO },
  {  1,  4,   75,  RISE, MONS_JOROGUMO },
  {  1,  4,   25,  FLAT, MONS_RADROACH },
  {  1,  4,   75,  RISE, MONS_RADROACH },
  {  1,  4,   50,  FLAT, MONS_SUN_MOTH },
  {  1,  4,   150, RISE, MONS_SUN_MOTH },
  {  1,  4,   50,  FLAT, MONS_SPARK_WASP },
